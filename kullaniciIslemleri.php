    ...
    <div class="main-content">
        <div class="sidebar">
            <ul class="list-group">
                <a href="hesapIslemleri.php">
                    <li class="list-group-item ">Hesap İşlemleri</li>
                </a>
                ...
                <a href="kullaniciIslemleri.php">
                    <li class="list-group-item active">Kullanıcı İşlemleri</li>
                </a>
            </ul>
        </div>
        ...
        <div class="main-right">
            ...
            <div class="form-group">
                ...
                <button style="margin-top:5px; float:right" type="submit" class="btn btn-dark ">Güncelle</button>
